...
def main(ctx):
  ...
  linux_cxx("OPENCL_LIB=pocl ENV_CXX_FLAGS=-Wno-unused-local-typedef -DBOOST_COMPUTE_MAX_CL_VERSION=101 ENV_CMAKE_OPTIONS=-DOpenCL_LIBRARY=${POCL_OPENCL_LIB} -DOpenCL_INCLUDE_DIR=${OPENCL_ROOT}/include Job 2", "g++", packages="g++-5 libltdl-dev libhwloc-dev pkg-config libedit-dev libboost-chrono1.58-dev libboost-date-time1.58-dev libboost-test1.58-dev libboost-system1.58-dev libboost-filesystem1.58-dev libboost-timer1.58-dev libboost-program-options1.58-dev libboost-thread1.58-dev python-yaml libopencv-dev", buildtype="boost", image="cppalliance/droneubuntu1604:1", environment={'OPENCL_LIB': 'pocl', 'ENV_CXX_FLAGS': '-Wno-unused-local-typedef -DBOOST_COMPUTE_MAX_CL_VERSION=101', 'ENV_CMAKE_OPTIONS': '-DOpenCL_LIBRARY=${POCL_OPENCL_LIB} -DOpenCL_INCLUDE_DIR=${OPENCL_ROOT}/include', 'DRONE_JOB_UUID': 'da4b9237ba'}),
  ...
  linux_cxx("OPENCL_LIB=pocl ENV_CXX_FLAGS=-Wno-unused-local-typedef -DBOOST_COMPUTE_MAX_CL_VERSION=102 ENV_CMAKE_OPTIONS=-DOpenCL_LIBRARY=${POCL_OPENCL_LIB} -DOpenCL_INCLUDE_DIR=${OPENCL_ROOT}/include Job 4", "g++", packages="g++-5 libltdl-dev libhwloc-dev pkg-config libedit-dev libboost-chrono1.58-dev libboost-date-time1.58-dev libboost-test1.58-dev libboost-system1.58-dev libboost-filesystem1.58-dev libboost-timer1.58-dev libboost-program-options1.58-dev libboost-thread1.58-dev python-yaml libopencv-dev", buildtype="boost", image="cppalliance/droneubuntu1604:1", environment={'OPENCL_LIB': 'pocl', 'ENV_CXX_FLAGS': '-Wno-unused-local-typedef -DBOOST_COMPUTE_MAX_CL_VERSION=102', 'ENV_CMAKE_OPTIONS': '-DOpenCL_LIBRARY=${POCL_OPENCL_LIB} -DOpenCL_INCLUDE_DIR=${OPENCL_ROOT}/include', 'DRONE_JOB_UUID': '1b64538924'}),
